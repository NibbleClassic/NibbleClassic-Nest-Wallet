...
const urlNibbleClassicRemoteNodes = "https://raw.githubusercontent.com/NibbleClassic/NibbleClassic-nodes-json/master/NibbleClassic-nodes.json"
...
func requestListRemoteNodes() (remoteNodes []node) {
	...
	theNodes := new(nodes)
	err := getJSONFromHTTPRequest(urlNibbleClassicRemoteNodes, theNodes)
